...
export default async function Home() {
  ...
  return <>
    ...
    <section className="grid home-grid">
      <div className="card feature-card"><span className="card-number">01</span><div><div className="eyebrow">This week</div><h2>Current season</h2>
        ...
        <Link className="text-link" href="/standings">See full standings <span aria-hidden="true">→</span></Link></div></div>
