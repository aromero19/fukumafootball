...
4. Obtain approval for the application deployment. Optional player emails require reviewed migration 20260911000001 and explicit hosted-migration approval; see optional-player-email.md. Never change hosted schema in the dashboard, reset the linked database, or rewrite applied migrations.
